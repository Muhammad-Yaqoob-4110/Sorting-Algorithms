...
//		select the rightmost element as pivot
	...
	void traverse_1000_csv()
	{
	    ...
	    string line;
	    ifstream myFile;
	    myFile.open("organizations-1000.csv");
	    while (myFile.good())
	    {
	        if(count == 1)
	        {
	...
	void traverse_10000_csv()
	{
	    ...
	    string line;
	    ifstream myFile;
	    myFile.open("organizations-10000.csv");
	    while (myFile.good())
	    {
	        if(count == 1)
	        {
	...
	void traverse_100000_csv()
	{
	    ...
	    string line;
	    ifstream myFile;
	    myFile.open("organizations-100000.csv");
	    while (myFile.good())
	    {
	        if(count == 1)
	        {
	...
	void traverse_500000_csv()
	{
	    ...
	    string line;
	    ifstream myFile;
	    myFile.open("organizations-500000.csv");
	    while (myFile.good())
	    {
	        if(count == 1)
	        {
	...
	void traverse_100_csv()
	{
	    ...
	    string line;
	    ifstream myFile;
	    myFile.open("organizations-100.csv");
	    while (myFile.good())
	    {
	        if(count == 1)
	        {
